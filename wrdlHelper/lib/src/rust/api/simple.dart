...
// `load_answer_words_from_assets`, `load_guess_words_from_assets`
...
/// *
/// * This function receives the actual word lists from Dart and stores them in
/// * Rust for optimal performance. This replaces the hardcoded 18 words with
/// * the full 15k+ word lists.
/// *
/// * # Arguments
/// * - `answer_words`: The 2,315 answer words from
/// *   official_wordle_words.json
/// * - `guess_words`: The 14,854+ guess words from
/// *   official_guess_words.txt
/// *
/// * # Performance
/// * - This is called once at startup after Dart loads the word lists
/// * - Subsequent calls to get_intelligent_guess_fast() will use these full
/// *   lists
///
...
/// *
/// * This function uses the wrdlHelper intelligent solver with Rust-managed
/// * word lists to avoid passing large data structures across FFI. Much faster
/// * than the original.
/// *
/// * # Arguments
...
/// *
/// * This function uses the exact same algorithm that achieved 99.8% success
/// * rate in the Rust benchmark. This is the high-performance reference
/// * implementation.
/// *
/// * # Arguments
/// * - `remaining_words`: Words that are still possible given current constraints
